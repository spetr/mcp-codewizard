...
- **TreeSitter Parsing** - Language-aware code chunking for 39 languages
...
TreeSitter chunking provides full AST-aware parsing for 39 languages:
...
| R | `.r`, `.R` | Functions, variables, assignments |
